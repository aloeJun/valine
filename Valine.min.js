        ...
        o.prototype.Q = function (e) {
            ...
            var C = function (t, n, r) {
                ...
                var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    c = l ? '<a class="vnick" rel="nofollow noopener noreferrer" href="' + l + '" target="_blank" >' + t.get("nick") + "</a>" + gat : '<span class="vnick">' + t.get("nick") + "</span>" + gat,
                    u = T.hide ? "" : qal ? '<img class="vimg" src="' + qal + '" referrerPolicy="no-referrer"/ alt="用户头像">' : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get("mail")) + T.params) + '" alt="用户头像">',
